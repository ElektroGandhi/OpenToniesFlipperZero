...
| **Log** | `AN` / `AUS` | Schreibt ein Diagnose-Log (`SD:/apps_data/toniekids/log.txt`) mit Zeitstempeln — u. a. ob/wann der Auto-Timer scharf wird und feuert. Zum Nachvollziehen, falls etwas nicht wie erwartet läuft. |
